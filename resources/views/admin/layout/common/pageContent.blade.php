            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <svg class="svg-inline--fa fa-house-user" aria-hidden="true"
                        focusable="false" data-prefix="fas" data-icon="house-user" role="img"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="" width="50"
                        height="50">
                        ...
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    {{ $dashboarddetails }}</div>
                            </div>
                            <div class="col-auto">
                                <svg class="svg-inline--fa fa-id-card-clip" aria-hidden="true" focusable="false"
                                    data-prefix="fas" data-icon="id-card-clip" role="img"
            ...
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <svg class="svg-inline--fa fa-id-card-clip" aria-hidden="true"
                            focusable="false" data-prefix="fas" data-icon="id-card-clip" role="img"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="" width="50"
                            height="50">
                            <path fill="currentColor"
                                d="M256 128h64c17.67 0 32-14.33 32-32V32c0-17.67-14.33-32-32-32H256C238.3 0 224 14.33 224 32v64C224 113.7 238.3 128 256 128zM528 64H384v48C384 138.5 362.5 160 336 160h-96C213.5 160 192 138.5 192 112V64H48C21.49 64 0 85.49 0 112v352C0 490.5 21.49 512 48 512h480c26.51 0 48-21.49 48-48v-352C576 85.49 554.5 64 528 64zM288 224c35.35 0 64 28.66 64 64s-28.65 64-64 64s-64-28.66-64-64S252.7 224 288 224zM384 448H192c-8.836 0-16-7.164-16-16C176 405.5 197.5 384 224 384h128c26.51 0 48 21.49 48 48C400 440.8 392.8 448 384 448z">
            ...
            <a href="{{ url('vcard') }}">
                <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">V-Card
                                </div>
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                        <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                            {{ $vcardcountDetails }}</div>
                                    </div>
                            ...
                            <div class="col-auto">
                                <svg class="svg-inline--fa fa-table-columns" aria-hidden="true" focusable="false"
                                    ...
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""width="50"
                                    height="50">
                                    <path fill="currentColor"
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                    VCard template</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $tempvcardcountDetails }}</div>
                            </div>
                            <div class="col-auto">
                                <svg class="svg-inline--fa fa-id-card-clip" aria-hidden="true" focusable="false"
                                    data-prefix="fas" data-icon="id-card-clip" role="img"
            ...
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <svg class="svg-inline--fa fa-house" aria-hidden="true"
                            focusable="false" data-prefix="fas" data-icon="house" role="img"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="" width="50"
                            height="50">
                            <path fill="currentColor"
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Vcard Sources</h6>
...
{{--
                ...
                {{-- <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        ...
                        <span class="mr-2">
                            <i class="fas fa-circle text-success"></i> Vcard
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-info"></i> Vcard Template
                        </span>
                    </div>
                </div>
            </div>
