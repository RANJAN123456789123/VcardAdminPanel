    ...
    <div class="container">
        <div class="vcard-three main-content w-100 mx-auto overflow-hidden">
            ...
            <div class="vcard-three__banner w-100 position-relative">
                <img src="{{ asset('assets/img/vcard3/vcard3-banner.png') }}" class="img-fluid banner-image"
                    alt="banner" />
            </div>
            {{-- profile --}}
            <div class="vcard_eight">
                ...
                <div class="vcard-eight_block">
                    <div class="d-flex flex-column">
                        ...
                        <span
                            class="avatar-designation text-white text-sm-start text-center">{{ isset($getuser->company_name) ? $getuser->company_name : 'NA' }}</span>
                    </div>
                </div>
            ...
            <div class="vcard-three__profile-details py-3 px-3">
                <h4 class="vcard-three-heading text-center">{{ isset($getUserData->name) ? $getUserData->name : 'NA' }}
                </h4>
                <span
                    class="profile-designation text-center d-block text-white">{{ isset($getUserData->designation) ? $getUserData->designation : 'NA' }}</span>
                <span
                    class="avatar-designation text-white text-sm-start text-center">{{ isset($getuser->company_name) ? $getuser->company_name : 'NA' }}</span>
                        ...
                        <div class="col-sm-6 col-12">
                            <div class="card event-card p-2 h-100 border-0 flex-sm-row flex-column align-items-center">
                                ...
                                <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                    ...
                                    <h5 class="event-name text-sm-start text-center mb-0 text-white">
                                        {{ isset($getUserData->email) ? $getUserData->email : 'NA' }}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-12">
                            <div class="card event-card p-2 h-100 border-0 flex-sm-row flex-column align-items-center">
                                ...
                                <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                    ...
                                    <h5 class="event-name text-center mb-0 text-white">
                        ...
                        <div class="col-sm-6 col-12">
                            <div class="card event-card p-2 h-100 border-0 flex-sm-row flex-column align-items-center">
                                ...
                                <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                    ...
                                    <h5 class="event-name text-center mb-0 text-white">
                                        {{ isset($getUserData->DOB) ? $getUserData->DOB : 'NA' }}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-12">
                            <div class="card event-card p-2 h-100 border-0 flex-sm-row flex-column align-items-center">
                                ...
                                <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                    ...
                                    <h5 class="event-name text-center mb-0 text-white">
                                        {{ isset($getUserData->location) ? $getUserData->location : 'NA' }}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card testimonial-card p-3 border-0 w-100">
                                <div
                                    ...
                                    <div class="user-details d-flex flex-column ms-sm-3 mt-sm-0 mt-2">
                                        <span
                                            class="user-name text-white text-sm-start text-center">{{ isset($getUserData->testimonial_title1) ? $getUserData->testimonial_title1 : 'NA' }}</span>
                                        <span
                                            class="user-designation text-white text-sm-start text-center">{{ isset($getUserData->subtitle1) ? $getUserData->subtitle1 : 'NA' }}</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="card testimonial-card p-3 border-0 w-100">
                                <div
                                    ...
                                    <div class="user-details d-flex flex-column ms-sm-3 mt-sm-0 mt-2">
                                        <span
                                            class="user-name text-white text-sm-start text-center">{{ isset($getUserData->testimonial_title2) ? $getUserData->testimonial_title2 : 'NA' }}</span>
                                        <span
                                            class="user-designation text-white text-sm-start text-center">{{ isset($getUserData->subtitle2) ? $getUserData->subtitle2 : 'NA' }}</span>
                                    </div>
                                </div>
                                <p class="review-message mb-2 text-sm-start text-center mt-2">
                            ...
                            <div class="col-12">
                                <div class="contact-form px-sm-5">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" placeholder="Mobile Number" class="form-control border-start-0" id="vcard1phone">
                                    </div>
                                    <div class="mb-3">
            ...
            <div class="d-sm-flex justify-content-center my-5">
                ...
                <button type="submit" class="vcard-three-btn text-white mt-4 d-block" id="addToContact">
                    <i class="fas fa-download me-2"></i> Download Vcard
                </button>

                <button type="button" class="vcard-three-btn text-white mt-4 d-block" data-toggle="modal"
