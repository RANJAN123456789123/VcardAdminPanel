        ...
        <div class="vcard-eight main-content w-100 mx-auto overflow-hidden">
            ...
            {{-- <div class="vcard-eight__profile d-flex align-items-center px-4 flex-sm-row flex-column position-relative">
                ...
                <a href="{{ isset($getUserData->email) ? url('vcard-login/' . $getUserData->id) : url('vcard-register/' . $getUserData->nfc_id) }}"
                    class="edit_profile" style="text-decoration: auto;"><i class="fas fa-pencil"></i><span><b>Edit</b></span> </a>
            </div> --}}
                ...
                <div class="row g-3 product-slider mt-2">
                    <div class="col-6">
                        <div class="card product-card p-3 border-0 w-100">
                            ...
                            <div class="product-details mt-3">
                                <h4 class="text-white">
                                    {{ isset($getUserData->producttitle1) ? $getUserData->producttitle1 : 'NA' }}</h4>
                    ...
                    <div class="col-6">
                        <div class="card product-card p-3 border-0 w-100">
                            ...
                            <div class="product-details mt-3">
                                <h4 class="text-white">
                                    {{ isset($getUserData->producttitle2) ? $getUserData->producttitle2 : 'NA' }}</h4>
                                <p class="mb-2 text-white">
                    ...
                    <div class="col-6">
                        <div class="card product-card p-3 border-0 w-100">
                            ...
                            <div class="product-details mt-3">
                                <h4 class="text-white">
                                    {{ isset($getUserData->producttitle3) ? $getUserData->producttitle3 : 'NA' }}</h4>
                                <p class="mb-2 text-white">
                        ...
                        <div class="card testimonial-card p-3 border-0 w-100">
                            <div
                                ...
                                <div class="user-details d-flex flex-column mt-2">
                                    <span
                                        class="user-name text-center">{{ isset($getUserData->testimonial_title1) ? $getUserData->testimonial_title1 : 'NA' }}</span>
                                    <span
                    ...
                    <div class="col-12">
                        <div class="card testimonial-card p-3 border-0 w-100">
                            <div
                                ...
                                <div class="user-details d-flex flex-column mt-2">
                                    <span
                                        class="user-name text-center">{{ isset($getUserData->testimonial_title2) ? $getUserData->testimonial_title2 : 'NA' }}</span>
                                    <span
