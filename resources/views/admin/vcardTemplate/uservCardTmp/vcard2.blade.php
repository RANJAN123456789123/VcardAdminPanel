            ...
            <div class="vcard-two__profile position-relative">
                <div class="avatar position-absolute top-0 translate-middle">
                    ...
                    <a href="{{ isset($getUserData->email) ? url('vcard-login/' . $getUserData->id) : url('vcard-register/' . $getUserData->nfc_id) }}"
                        class="edit_profile" style="text-decoration: auto;"><i
                            class="fas fa-pencil"></i><span><b>Edit</b></span> </a>
                </div>
            </div>
            {{-- profile details --}}
            <div class="vcard-two__profile-details py-3 px-3">
                <h4 class="vcard-two-heading">{{ isset($getUserData->name) ? $getUserData->name : 'NA' }}</h4>
                <span
                    class="profile-designation">{{ isset($getUserData->designation) ? $getUserData->designation : 'NA' }}</span><br>
                <span
                    class="profile-designation">{{ isset($getUserData->company_name) ? $getUserData->company_name : 'NA' }}</span>
                            ...
                            <div
                                ...
                                <div class="me-sm-3">
                                    ...
                                    <div class="user-details d-flex justify-content-sm-start justify-content-center">
                                        <span
                                            class="user-name">{{ isset($getUserData->testimonial_title1) ? $getUserData->testimonial_title1 : 'NA' }}</span>
                                        <span class="user-designation">-
                                            {{ isset($getUserData->subtitle1) ? $getUserData->subtitle1 : 'NA' }}</span>
                                    </div>
                                </div>
