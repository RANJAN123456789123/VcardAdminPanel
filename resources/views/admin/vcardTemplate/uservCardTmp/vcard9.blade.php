    ...
    <div class="container">
        <div class="vcard-nine main-content w-100 mx-auto overflow-hidden">
            ...
            <div class="vcard-nine__profile-details py-3 px-3">
                <h4 class="profile-name text-center mb-1">{{ isset($getUserData->name) ? $getUserData->name : 'NA' }}
                </h4>
                <span
                    class="profile-designation text-center d-block">{{ isset($getUserData->designation) ? $getUserData->designation : 'NA' }}</span>
                <span
                    class="profile-designation text-center d-block">{{ isset($getUserData->company_name) ? $getUserData->company_name : 'NA' }}</span>
            ...
            <div class="d-sm-flex justify-content-center mt-5">
                <button type="submit" class="vcard-ten-btn mt-4 d-block btn" onclick="downloadQRCode()">
