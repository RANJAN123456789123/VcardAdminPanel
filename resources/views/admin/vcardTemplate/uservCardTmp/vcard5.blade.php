                        ...
                        <div class="row">
                            <div class="col-sm-6 pb-4">
                                <div class="about-details">
                                    ...
                                    <p class="about-title mb-0">
                                        {{ isset($getUserData->email) ? $getUserData->email : 'NA' }}
                                    </p>
                                </div>
                            </div>
                            <div class="col-sm-6 pb-4">
                            ...
                            <div class="col-sm-6 pb-4">
                                <div class="about-details">
                                    ...
                                    <p class="about-title mb-0">
                                        {{ isset($getUserData->phone_number) ? $getUserData->phone_number : 'NA' }}</p>
                                </div>
                            </div>
                            <div class="col-sm-6 pb-4">
                                <div class="about-details">
                        ...
                        <div class="row">
                            <div class="col-12 mb-4">
                                <div class="service-info d-flex align-items-center">
                                    ...
                                    <div>
                                        <span
                                            class="service-heading">{{ isset($getUserData->title1) ? $getUserData->title1 : 'NA' }}</span>
                            ...
                            <div class="col-12 mb-4">
                                <div class="service-info d-flex align-items-center">
                                    ...
                                    <div>
                                        <span
                                            class="service-heading">{{ isset($getUserData->title2) ? $getUserData->title2 : 'NA' }}</span>
                                        <p class="mb-0 service-title">
                            ...
                            <div class="col-12 mb-4">
                                <div class="service-info d-flex align-items-center">
                                    <div class="service-img me-3 rounded-circle">
                                        <img
                                            src="{{ isset($getUserData->icon3) ? asset('our_services/' . $getUserData->icon3) : asset('img/No_image_available.svg') }}ss" />
                                    </div>
                                    <div>
                                        <span
                                            class="service-heading">{{ isset($getUserData->title3) ? $getUserData->title3 : 'NA' }}</span>
                                        <p class="mb-0 service-title">
                            ...
                            <div class="col-12 mb-4">
                                <div class="service-info d-flex align-items-center">
                                    <div class="service-img me-3 rounded-circle">
                                        <img
                                            src="{{ isset($getUserData->icon4) ? asset('our_services/' . $getUserData->icon4) : asset('img/No_image_available.svg') }}s" />
                                    </div>
                                    <div>
                                        <span
                                            class="service-heading">{{ isset($getUserData->title4) ? $getUserData->title4 : 'NA' }}</span>
                                        <p class="mb-0 service-title">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="mb-0 testi-card-text">
                                                            {{ isset($getUserData->subtitle1) ? $getUserData->subtitle1 : 'NA' }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="mb-0 testi-card-text">
                                                            {{ isset($getUserData->subtitle2) ? $getUserData->subtitle2 : 'NA' }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
