        ...
        <div class="row d-flex justify-content-center">
            <div class="main-bg p-0">
                        ...
                        <div class="main-profile position-relative">
                            <div class="profile-img">
                                <div class="row d-flex align-items-center mb-4 justify-content-center">
                                    ...
                                    <div class="col-md-8">
                                        <div>
                                            <h3 class="big-title text-light">
                                                {{ isset($getUserData->name) ? $getUserData->name : 'NA' }}</h3>
                                            <p class="small-title text-light">
                                    ...
                                    <div class="col-sm-6 mb-4">
                                        <div class="card border-0 bg-transparent">
                                            <div class="event-icon text-white">
                                                ...
                                                <span>{{ isset($getUserData->email) ? $getUserData->email : 'NA' }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 mb-4">
                                        <div class="card border-0 bg-transparent">
                                            <div class="event-icon text-white">
                                                <img src="{{ asset('assets/img/vcard6/call.png') }}"
                                                    class="img-fluid me-3" />
                                                <span>{{ isset($getUserData->phone_number) ? $getUserData->phone_number : 'NA' }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 mb-4">
                                        <div class="card border-0 bg-transparent">
                                            <div class="event-icon text-white">
                                                <img src="{{ asset('assets/img/vcard6/cake.png') }}"
                                                    class="img-fluid me-3" />
                                                <span>{{ isset($getUserData->DOB) ? $getUserData->DOB : 'NA' }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 mb-4">
                                        <div class="card border-0 bg-transparent">
                                            <div class="event-icon text-white">
                                                <img src="{{ asset('assets/img/vcard6/location.png') }}"
                                                    class="img-fluid me-3" />
                                                <span>{{ isset($getUserData->location) ? $getUserData->location : 'NA' }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="main-service-our position-relative">
                    ...
                    <img src="{{ asset('assets/img/vcard6/box.png') }}"
                        class="img-fluid position-absolute box-img" />
                        ...
                        <div class="main-our-section position-relative">
                            ...
                            <div class="row">
                                <div class="col-md-6 text-light">
                                    ...
                                    <div>
                                        <h5 class="our-heading mb-0">
                                            {{ isset($getUserData->title1) ? $getUserData->title1 : 'NA' }}</h5>
                                        <p class="our-title">
                                ...
                                <div class="col-md-6 text-light">
                                    ...
                                    <div>
                                        <h5 class="our-heading mb-0">
                                            {{ isset($getUserData->title2) ? $getUserData->title2 : 'NA' }}</h5>
                                        <p class="our-title">
                                ...
                                <div class="col-md-6 text-light">
                                    ...
                                    <div>
                                        <h5 class="our-heading mb-0">
                                            {{ isset($getUserData->title3) ? $getUserData->title3 : 'NA' }}</h5>
                                        <p class="our-title">
                                ...
                                <div class="col-md-6 text-light">
                                    <div class="our-img mb-3">
                                        <img src="{{ isset($getUserData->icon4) ? asset('our_services/' . $getUserData->icon4) : asset('img/No_image_available.svg') }}s"
                                            class="img-fluid me-3" />
                                    </div>
                                    <div>
                                        <h5 class="our-heading mb-0">
                                            {{ isset($getUserData->title4) ? $getUserData->title4 : 'NA' }}</h5>
                                        <p class="our-title">
                                ...
                                <div class="col-6">
                                    <div class="card w-100 h-100 bg-transparent border-0 text-light">
                                        ...
                                        <div class="product-details mt-3">
                                            ...
                                            <span
                                                class="text-black">${{ isset($getUserData->productprice3) ? $getUserData->productprice3 : 'NA' }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-6">
                                    <div class="card w-100 h-100 bg-transparent border-0 text-light">
                                        ...
                                        <div
                                            class="testimonial-user d-flex justify-content-center flex-column align-center mt-3">
                                            <h5 class="user-name text-center position-relative mt-2 mb-0">
                                                {{ isset($getUserData->testimonial_title3) ? $getUserData->testimonial_title3 : 'NA' }}
                                            </h5>
                                            <span
                                                class="user-designation text-center">{{ isset($getUserData->subtitle3) ? $getUserData->subtitle3 : 'NA' }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
