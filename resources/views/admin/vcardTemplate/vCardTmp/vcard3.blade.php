    ...
    <div class="container">
        <div class="vcard-three main-content w-100 mx-auto overflow-hidden">
            ...
            <div class="vcard-three__profile-details py-3 px-3">
                <h4 class="vcard-three-heading text-center">{{ isset($getuser->name) ? $getuser->name : 'NA' }}</h4>
                <span
                    class="profile-designation text-center d-block text-white">{{ isset($getuser->designation) ? $getuser->designation : 'NA' }}</span>
                ...
                <div class="container">
                    ...
                    <div class="row mt-3 g-3">
                        ...
                        <div class="col-sm-6 col-12">
                            <div class="card service-card p-3 h-100 d-flex align-items-center bg-white">
                                <div class="service-image d-flex justify-content-center align-items-center">
                                    <img src="{{ isset($getuser->icon4) ? asset('our_services/' . $getuser->icon4) : asset('img/No_image_available.svg') }}" alt="service" />
                                </div>
                                <div class="service-details mt-3">
                                    <h4 class="service-title text-center">{{ isset($getuser->title4) ? $getuser->title4 : 'NA' }}</h4>
                                    <p class="service-paragraph mb-0 text-center">
                            ...
                            <div class="card testimonial-card p-3 border-0 w-100">
                                <div
                                    ...
                                    <div class="user-details d-flex flex-column ms-sm-3 mt-sm-0 mt-2">
                                        <span
                                            class="user-name text-white text-sm-start text-center">{{ isset($getuser->testimonial_title1) ? $getuser->testimonial_title1 : 'NA' }}</span>
                                        <span
                                            class="user-designation text-white text-sm-start text-center">{{ isset($getuser->subtitle1) ? $getuser->subtitle1 : 'NA' }}</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="card testimonial-card p-3 border-0 w-100">
                                <div
                                    ...
                                    <div class="user-details d-flex flex-column ms-sm-3 mt-sm-0 mt-2">
                                        <span
                                            class="user-name text-white text-sm-start text-center">{{ isset($getuser->testimonial_title2) ? $getuser->testimonial_title2 : 'NA' }}</span>
                                        <span
                                            class="user-designation text-white text-sm-start text-center">{{ isset($getuser->subtitle2) ? $getuser->subtitle2 : 'NA' }}</span>
                                    </div>
                                </div>
                                <p class="review-message mb-2 text-sm-start text-center mt-2">
