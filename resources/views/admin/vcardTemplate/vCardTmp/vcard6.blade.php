                                    ...
                                    <div class="col-md-8">
                                        <div>
                                            <h3 class="big-title text-light">
                                                {{ isset($getuser->name) ? $getuser->name : 'NA' }}</h3>
                        ...
                        <div class="main-our-section position-relative">
                            ...
                            <div class="row">
                                <div class="col-md-6 text-light">
                                    ...
                                    <div>
                                        <h5 class="our-heading mb-0">{{ isset($getuser->title1) ? $getuser->title1 : 'NA' }}</h5>
                                        <p class="our-title">{{ isset($getuser->description1) ? $getuser->description1 : 'NA' }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 text-light">
                                    ...
                                    <div>
                                        <h5 class="our-heading mb-0">{{ isset($getuser->title2) ? $getuser->title2 : 'NA' }}</h5>
                                        <p class="our-title">{{ isset($getuser->description2) ? $getuser->description2 : 'NA' }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 text-light">
                                    ...
                                    <div>
                                        <h5 class="our-heading mb-0">{{ isset($getuser->title3) ? $getuser->title3 : 'NA' }}</h5>
                                        <p class="our-title">{{ isset($getuser->description3) ? $getuser->description3 : 'NA' }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 text-light">
                                    ...
                                    <div>
                                        <h5 class="our-heading mb-0">{{ isset($getuser->title4) ? $getuser->title4 : 'NA' }}</h5>
                                        <p class="our-title">{{ isset($getuser->description4) ? $getuser->description4 : 'NA' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-3 product-card">
                                <div class="col-6">
                                    <div class="card  w-100 h-100 bg-transparent border-0 text-light">
                                        ...
                                        <div class="product-details mt-3">
                                            <h4>{{ isset($getuser->producttitle1) ? $getuser->producttitle1 : 'NA' }}
                                            </h4>
                                            <p class="mb-2">
                                ...
                                <div class="col-6">
                                    <div class="card w-100 h-100 bg-transparent border-0 text-light">
                                        ...
                                        <div class="product-details mt-3">
                                            <h4>{{ isset($getuser->producttitle2) ? $getuser->producttitle2 : 'NA' }}
                                            </h4>
                                            <p class="mb-2">
                                ...
                                <div class="col-6">
                                    <div class="card w-100 h-100 bg-transparent border-0 text-light">
                                        ...
                                        <div class="product-details mt-3">
                                            <h4>{{ isset($getuser->producttitle3) ? $getuser->producttitle3 : 'NA' }}
                                            </h4>
                                            <p class="mb-2">
                                ...
                                <div class="col-6">
                                    <div class="card w-100 h-100 bg-transparent border-0 text-light">
                                        ...
                                        <div
                                            class="testimonial-user d-flex justify-content-center flex-column align-center mt-3">
                                            <h5 class="user-name text-center position-relative mt-2 mb-0">
                                                {{ isset($getuser->testimonial_title3) ? $getuser->testimonial_title3 : 'NA' }}
                                            </h5>
                                            <span
                                                class="user-designation text-center">{{ isset($getuser->subtitle3) ? $getuser->subtitle3 : 'NA' }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
