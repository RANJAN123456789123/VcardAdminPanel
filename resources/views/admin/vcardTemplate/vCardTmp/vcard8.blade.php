    ...
    <div class="container">
        <div class="vcard-eight main-content w-100 mx-auto overflow-hidden">
            ...
            <div class="vcard-eight__banner w-100 position-relative">
                <img src="{{ asset('assets/img/vcard8/vcard8-banner.png') }}"
            ...
            <div class="vcard-eight__social py-3 px-3 position-relative">
                <div class="social-icons d-flex justify-content-center pt-4">
                    <span
                        class="social-back rounded-circle d-flex justify-content-center align-items-center me-sm-3 me-1">
                        <a href="https://www.facebook.com"><i class="fab fa-facebook facebook-icon icon"></i></a>
                    </span>
                    <span
                        class="social-back rounded-circle d-flex justify-content-center align-items-center mx-sm-3 mx-1">
                    ...
                    <span
                        class="social-back rounded-circle d-flex justify-content-center align-items-center ms-sm-3 ms-1">
                        ...
                        <div class="card event-card p-4">
                            <div class="row g-4">
                                ...
                                <div class="col-sm-6 col-12">
                                    <div
                                        class="event-icon rounded-circle d-flex justify-content-center align-items-center mx-auto mb-2">
                                        <img src="{{ asset('assets/img/vcard8/vcard8-phone.png') }}"
                                            alt="mobile" />
                                    </div>
                                    <div class="event-details">
            ...
            <div class="vcard-eight__service py-4 position-relative px-sm-4 px-3">
                <div class="container">
                    <h4 class="vcard-eight-heading heading-line position-relative text-center d-block mx-auto pb-3">Our
                        Services</h4>
                    <div class="row mt-3 service-bg bg-white">
                        ...
                        <div class="col-sm-6 col-12 p-3">
                            <div class="card service-card px-3 py-0 h-100 border-0">
                                <div
                                    class="service-image d-flex justify-content-center align-items-center rounded-circle">
                                    <img src="{{ isset($getuser->icon4) ? asset('our_services/' . $getuser->icon4) : asset('img/No_image_available.svg') }}" alt="UI/UX" />
                                </div>
                                <div class="service-details mt-3">
                                    <h4 class="service-title text-sm-start text-center">{{ isset($getuser->title4) ? $getuser->title4 : 'NA' }}</h4>
                                    <p class="service-paragraph mb-0 text-sm-start text-center">
            ...
            <div class="vcard-eight__gallery py-4 position-relative px-sm-4 px-3">
                <h4 class="vcard-eight-heading heading-line position-relative text-center d-block mx-auto pb-3">Gallery
                </h4>
                    ...
                    <div class="col-6">
                        <div class="card product-card p-3 border-0 w-100">
                            ...
                            <div class="product-details mt-3">
                                <h4 class="text-white">
                                    {{ isset($getuser->producttitle1) ? $getuser->producttitle1 : 'NA' }}</h4>
                                <p class="mb-2 text-white">
                                    {{ isset($getuser->productdescription1) ? $getuser->productdescription1 : 'NA' }}
                                </p>
                                <span
                                    class="text-white">${{ isset($getuser->productprice1) ? $getuser->productprice1 : 'NA' }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="card product-card p-3 border-0 w-100">
                            ...
                            <div class="product-details mt-3">
                                <h4 class="text-white">
                                    {{ isset($getuser->producttitle2) ? $getuser->producttitle2 : 'NA' }}</h4>
                                <p class="mb-2 text-white">
                                    {{ isset($getuser->productdescription2) ? $getuser->productdescription2 : 'NA' }}
                                </p>
                                <span
                                    class="text-white">${{ isset($getuser->productprice2) ? $getuser->productprice2 : 'NA' }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="card product-card p-3 border-0 w-100">
                            ...
                            <div class="product-details mt-3">
                                <h4 class="text-white">
                                    {{ isset($getuser->producttitle3) ? $getuser->producttitle3 : 'NA' }}</h4>
                                <p class="mb-2 text-white">
                                    {{ isset($getuser->productdescription3) ? $getuser->productdescription3 : 'NA' }}
                                </p>
                                <span
                                    class="text-white">${{ isset($getuser->productprice3) ? $getuser->productprice3 : 'NA' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card testimonial-card p-3 border-0 w-100">
                            <div
                                ...
                                <div class="user-details d-flex flex-column mt-2">
                                    <span
                                        class="user-name text-center">{{ isset($getuser->testimonial_title1) ? $getuser->testimonial_title1 : 'NA' }}</span>
                                    <span
                    ...
                    <div class="col-12">
                        <div class="card testimonial-card p-3 border-0 w-100">
                            <div
                                ...
                                <div class="user-details d-flex flex-column mt-2">
                                    <span
                                        class="user-name text-center">{{ isset($getuser->testimonial_title2) ? $getuser->testimonial_title2 : 'NA' }}</span>
                                    <span
            ...
            <div class="d-sm-flex justify-content-center mt-5">
                <button type="submit" class="vcard-eight-btn mt-4 d-block btn text-white" id="addToContact">
